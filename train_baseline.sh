...
python ./train.py \
--exp_name de_en_baseline \
--dump_path ${NMT_EXP_DIR}/dumped/ \
--data_path "${NMT_DATA_DIR}/processed/" \
--reload_model "${NMT_EXP_DIR}/dumped/finetune_de_hsb_mlm_tlm_full-vocab/40000818/best-valid_mlm_ppl.pth,${NMT_EXP_DIR}/dumped/finetune_de_hsb_mlm_tlm_full-vocab/40000818/best-valid_mlm_ppl.pth" \
