...
--reload_model "${NMT_EXP_DIR}/dumped/finetune_de_hsb_mlm_tlm/39332228/best-valid_hsb_mlm_ppl.pth,${NMT_EXP_DIR}/dumped/finetune_de_hsb_mlm_tlm/39332228/best-valid_hsb_mlm_ppl.pth" \
...
--epoch_size 5000 \
--eval_bleu true \
--stopping_criterion 'valid_de-hsb_mt_acc,10' \
--validation_metrics 'valid_de-hsb_mt_acc' \
--use_lang_emb true \
--master_port 10001 \
--debug_train false \
--max_vocab 101681 \
